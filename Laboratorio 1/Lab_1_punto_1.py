...
class Lab_1_punto_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab_muestreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_muestreo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_1_punto_1")
...
def main(top_block_cls=Lab_1_punto_1, options=None):
